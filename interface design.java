public class Main{
	...
	public String save_in_chain(String module_source, String encrypted_message) throws WriteFailureException {return "";}
    /* 
	...
	String fetch_from_chain(String label) throws ReadFailureException {return "";}
	/* 
